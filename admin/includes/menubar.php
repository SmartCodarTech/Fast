<aside class="main-sidebar">
  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <!--li class=""><a href="user.php"><i class="fa fa-user"></i> <span>Add Admin</span></a></li-->
      ...
      <!--li class=""><a href="user.php" data-toggle="modal"><i class="fa fa-user"></i> <span>Add Admin</span></a></li-->
    </ul>
  </section>
  <!-- /.sidebar -->
</aside>

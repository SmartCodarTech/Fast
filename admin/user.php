    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="add_user.php" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="password" class="form-control" id="confirm_password" name="confrim_password" required>
                    </div>
                </div>
                <div class="form-group">
            ...
            <div class="modal-footer">
              ...
              <button type="submit" class="btn btn-primary btn-flat" name="submit"><i class="fa fa-save"></i>Add</button>
              </form>
            </div>
        </div>
    </div>
